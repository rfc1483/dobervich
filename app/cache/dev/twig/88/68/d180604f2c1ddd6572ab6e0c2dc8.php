...
class __TwigTemplate_8868d180604f2c1ddd6572ab6e0c2dc8 extends Twig_Template
{
    protected $parent;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 3
        $context['__internal_8868d180604f2c1ddd6572ab6e0c2dc8_1'] = $this;
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context['_key'] => $context['listener']) {
            ...
            echo "</code></td>
                <td><code>";
            // line 23
            echo twig_escape_filter($this->env, $this->getAttribute($context['__internal_8868d180604f2c1ddd6572ab6e0c2dc8_1'], "display_listener", array($this->getContext($context, 'listener'), ), "method", false), "html");
            echo "</code></td>
            </tr>
        ";
        }
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['listener']) {
                ...
                echo "</code></td>
                    <td><code>";
                // line 40
                echo twig_escape_filter($this->env, $this->getAttribute($context['__internal_8868d180604f2c1ddd6572ab6e0c2dc8_1'], "display_listener", array($this->getAttribute($this->getContext($context, 'listeners'), $this->getContext($context, 'listener'), array(), "array", false), ), "method", false), "html");
                echo "</code></td>
                </tr>
            ";
            }
