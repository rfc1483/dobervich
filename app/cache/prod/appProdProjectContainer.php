...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:\\xampp\\htdocs\\dobervich\\app/cache/prod/annotations', false);
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'blog_db', 'host' => 'localhost', 'user' => 'root', 'password' => '', 'driver' => 'pdo_mysql', 'port' => NULL, 'logging' => false, 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Doctrine\Common\EventManager());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->setProxyDir('C:\\xampp\\htdocs\\dobervich\\app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file.temporary_storage'] = new \Symfony\Component\HttpFoundation\File\SessionBasedTemporaryStorage($this->get('session'), 'b42f8584b909631467c934396353b09beb1428a6', 'C:\\xampp\\htdocs\\dobervich\\app/cache/prod/upload');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:\\xampp\\htdocs\\dobervich\\app/logs/prod.log', 100, false);
    }
    ...
    {
        return $this->services['translator.real'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/prod/translations', 'debug' => false), $this->get('session'));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'cache' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/prod/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, 'C:\\xampp\\htdocs\\dobervich\\app/../web', false);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/prod',
            ...
            'router.resource' => 'C:\\xampp\\htdocs\\dobervich\\app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/prod/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/prod/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/prod/assetic',
