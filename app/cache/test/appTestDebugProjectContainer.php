...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:\\xampp\\htdocs\\dobervich\\app/cache/test/annotations', true);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_5b1d0dfee5679412b4eb4605aa7bafdd');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_5b1d0dfee5679412b4eb4605aa7bafdd');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_5b1d0dfee5679412b4eb4605aa7bafdd');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bundle\DoctrineBundle\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => 'C:\\xampp\\htdocs\\dobervich\\src\\Company\\BlogBundle\\Entity')), 'Company\\BlogBundle\\Entity');
        ...
        $e->setProxyDir('C:\\xampp\\htdocs\\dobervich\\app/cache/test/doctrine/orm/Proxies');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('onCoreRequest', 'test.session.listener', 128);
        $instance->addListenerService('onCoreResponse', 'test.session.listener', -128);
    ...
    {
        return $this->services['file.temporary_storage'] = new \Symfony\Component\HttpFoundation\File\SessionBasedTemporaryStorage($this->get('session'), 'b42f8584b909631467c934396353b09beb1428a6', 'C:\\xampp\\htdocs\\dobervich\\app/cache/test/upload');
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:\\xampp\\htdocs\\dobervich\\app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'b42f8584b909631467c934396353b09beb1428a6');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:\\xampp\\htdocs\\dobervich\\app/logs/test.log', 100, false);
    }
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('C:\\xampp\\htdocs\\dobervich\\app/cache/test', 'apptestUrlMatcher', 'apptestUrlGenerator');
    }
    ...
    {
        return $this->services['session.storage'] = new \Symfony\Component\HttpFoundation\SessionStorage\FilesystemSessionStorage('C:\\xampp\\htdocs\\dobervich\\app/cache/test/sessions', array('lifetime' => 3600));
    }
    ...
    {
        return $this->services['symfony.webconfigurator'] = new \Symfony\Bundle\WebConfiguratorBundle\Configurator('C:\\xampp\\htdocs\\dobervich\\app');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper('', 'C:\\xampp\\htdocs\\dobervich\\app');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Bundle\FrameworkBundle\Test\SessionListener A Symfony\Bundle\FrameworkBundle\Test\SessionListener instance.
     */
    protected function getTest_Session_ListenerService()
    {
        return $this->services['test.session.listener'] = new \Symfony\Bundle\FrameworkBundle\Test\SessionListener($this);
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/test/twig', 'charset' => 'UTF-8'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, 'C:\\xampp\\htdocs\\dobervich\\app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:\\xampp\\htdocs\\dobervich\\app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['profiler.storage'] = new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:C:\\xampp\\htdocs\\dobervich\\app/cache/test/profiler.db', '', '', 86400);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:\\xampp\\htdocs\\dobervich\\app',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/test',
            'kernel.logs_dir' => 'C:\\xampp\\htdocs\\dobervich\\app/logs',
            ...
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => 'b42f8584b909631467c934396353b09beb1428a6',
            ...
            'debug.container.dump' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/test/appTestDebugProjectContainer.xml',
            'kernel.cache_warmup' => false,
            'kernel.secret' => 'b42f8584b909631467c934396353b09beb1428a6',
            ...
            'test.session.listener.class' => 'Symfony\\Bundle\\FrameworkBundle\\Test\\SessionListener',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\dobervich\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle\\DependencyInjection/../../../Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'sqlite:C:\\xampp\\htdocs\\dobervich\\app/cache/test/profiler.db',
            ...
            'router.resource' => 'C:\\xampp\\htdocs\\dobervich\\app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/test/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/test/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\xampp\\htdocs\\dobervich\\app/cache/test/assetic',
            ...
            'kernel.compiled_classes' => array(
                ...
                2 => 'Symfony\\Component\\HttpFoundation\\SessionStorage\\FilesystemSessionStorage',
